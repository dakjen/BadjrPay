...
export async function setAppData(data) {
  ...
  await sql`
    INSERT INTO settings (id, company_name, company_address, company_phone, tax_state, tax_local_rate, tax_filing)
    VALUES (1, ${s.companyName || ''}, ${s.companyAddress || ''}, ${s.companyPhone || ''}, ${s.taxState || 'MD'}, ${s.taxLocalRate === '' || s.taxLocalRate == null ? 3.2 : Number(s.taxLocalRate)}, ${s.taxFiling || 'single'})
