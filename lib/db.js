...
import { initBillingDb, reconcileOnlinePayments, listOnlinePaymentsByInvoice } from "./billing-db";
...
export async function getAppData() {
  ...
  const [settingsRows, clients, categories, services, invoiceRows, itemRows, installmentRows, projects, onlinePayments] = await Promise.all([
