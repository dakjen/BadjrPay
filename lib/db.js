...
export async function getAppData() {
  ...
  return {
    ...
    settings: {
      ...
      taxRate: s.tax_rate == null ? 25 : parseFloat(s.tax_rate),
    },
  };
}
...
export async function setAppData(data) {
  ...
  await sql`
    INSERT INTO settings (id, company_name, company_address, company_phone, tax_rate)
    VALUES (1, ${s.companyName || ''}, ${s.companyAddress || ''}, ${s.companyPhone || ''}, ${s.taxRate == null || s.taxRate === '' ? 25 : Number(s.taxRate)})
