  ...
  <tr>
    <td align="center" style="padding:40px 16px;">
      <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #E2DDD3;">
        <tr>
          <td style="background-color:#F7F5F0;border-bottom:3px solid #0B2D65;padding:20px 32px;">
        ...
        <tr>
          <td style="padding:32px 32px 24px;">
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin:28px 0 8px;">
              <tr><td align="center"><a href="${escHtml(payUrl)}" style="display:inline-block;background-color:#476C2E;color:#ffffff;text-decoration:none;font-size:15px;font-weight:600;padding:14px 32px;border-radius:8px;">Set up payment</a></td></tr>
              <tr><td align="center" style="font-size:12px;color:#888888;padding-top:12px;">Secure checkout powered by Stripe. Or paste this link into your browser:<br /><a href="${escHtml(payUrl)}" style="color:#476C2E;word-break:break-all;">${escHtml(payUrl)}</a></td></tr>
            </table>
          </td>
        </tr>
        <tr>
