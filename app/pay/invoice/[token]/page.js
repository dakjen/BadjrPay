...
const c = { bg: "#F7F5F0", surface: "#FFFFFF", surfaceAlt: "#F0EDE6", border: "#E2DDD3", borderLight: "#EDE9E1", text: "#1A1A1A", textSecondary: "#6B6560", textMuted: "#9C9590", accent: "#476C2E", success: "#3F7A2E", successLight: "#E6F1DE", warning: "#B8811A", warningLight: "#FFF3DC", danger: "#8A1C1C", dangerLight: "#F7E5E5" };
